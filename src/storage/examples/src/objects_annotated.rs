...
// [Jules: Rust]
// This module file exposes sub-modules for object-related examples.
// This is where most of the interesting work happens: reading, writing, and managing objects.
