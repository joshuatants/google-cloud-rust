...
// [Jules: SDK]
// Signed URLs allow you to give time-limited access to a specific object to someone without a Google account.
// You sign the URL with your credentials, and anyone with the URL can access the object.
// This enum defines how the URL is formatted.
...
// [Jules: Rust]
// `#[derive(Default)]` allows us to create a default value for this enum.
// The variant marked with `#[default]` (PathStyle) will be returned by `UrlStyle::default()`.
